...
async def start(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/kannadamovieskannadadubb'),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/kannadamovieskannadadubb')
        ],
        [
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/kannadamovieskannadadubb'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/kannadamovieskannadadubb')],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/kannadamovieskannadadubb'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
            ])
        )
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/preethudg')]
            ])
        )
        ...
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/preethudg')]
            ])
        )
    elif data == "plans":
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴄʟᴏsᴇ", callback_data="close"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/preethudg')]
            ])
        )
    elif data == "about":
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/kannadamovieskannadadubb'), InlineKeyboardButton("ᴄᴏᴍᴍᴀɴᴅs •", callback_data="help")],
                [InlineKeyboardButton("• ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/preethudg'), InlineKeyboardButton("ɴᴇᴛᴡᴏʀᴋ •", url='https://t.me/kannadamovieskannadadubb')],
...
async def donation(client, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url='https://t.me/preethudg')]
    ])
...
async def getpremium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/preethudg"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
...
async def premium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("sᴇɴᴅ ss", url="https://t.me/preethudg"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
